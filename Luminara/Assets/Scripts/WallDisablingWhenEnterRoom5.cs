...
public class WallDisablingWhenEnterRoom5 : MonoBehaviour
{
    public Grid grid; // assign this in the Inspector or find it in Start()
    public string Walls_deactivatable = "Room5/Room5_Walls_deactivatable";
    public string Doors = "Room5/Room5_Doors";
