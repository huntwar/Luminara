...
public class WallDisablingWhenEnterRoom6 : MonoBehaviour
{
    public Grid grid; // assign this in the Inspector or find it in Start()
    public string Walls_deactivatable = "Room6/Room6_Walls_deactivatable";
    public string Doors = "Room6/Room6_Doors";
