...
public class WallDisablingHallways : MonoBehaviour
{
    public Grid grid; // assign this in the Inspector or find it in Start()
    public string Walls_deactivatable = "Hallway/Hallway_Walls_deactivatable";
    public string Doors = "Hallway/Hallway_Doors";
    //public string ChandelierOutsideLeft = "Hallway_ChandelierOutsideLeft";
    //public string ChandelierOutsideRight = "Hallway_ChandelierOutsideRight";
