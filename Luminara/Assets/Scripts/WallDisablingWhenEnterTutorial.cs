...
public class WallDisablingWhenEnterTutorial : MonoBehaviour
{
    public Grid grid; // assign this in the Inspector or find it in Start()
    public string Walls_deactivatable = "Tutorial_Walls_deactivatable";
    public string Doors = "Tutorial_Doors";
    public string ChandelierOutsideLeft = "Tutorial_ChandelierOutsideLeft";
    public string ChandelierOutsideRight = "Tutorial_ChandelierOutsideRight";
