...
public class WallDisablingWhenEnterRoom4 : MonoBehaviour
{
    public Grid grid; // assign this in the Inspector or find it in Start()
    public string Walls_deactivatable = "Room4/Room4_Walls_deactivatable";
    public string Doors = "Room4/Room4_Doors";
